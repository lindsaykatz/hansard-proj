...
![Snapshot of the beginning of the XML file for Hansard on 25 February 2020](xml1.png){#fig-xml1}
...
![First 10 rows of the lookup table from 19 October 2017 Hansard processing](lookup_ex.png){#fig-lookup width="448"}
...
![10 rows of the pattern lookup table from 12 December 2012 Hansard processing](pattern_lookup.png){#fig-patterns}
...
![Number of speeches made on each sitting day in the House of Representatives](n_daily_speeches.png){#fig-dailyspeeches width="440"}
...
![Daily number of unique names detected in our Hansard data](n_unique_names.png){#fig-names width="440"}
