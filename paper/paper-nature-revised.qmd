...
read_csv("s_by_party_name.csv", show_col_types = F) |> 
  ...
  kableExtra::kable_styling(full_width = F, latex_options = "HOLD_position")
#### check NAT vs NPA full names - are these correct? google is confusing me
```
