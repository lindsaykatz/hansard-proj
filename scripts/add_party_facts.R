...
for (i in 1:length(all_csvs)){
  ...
  thisFile <- readr::read_csv(paste0("hansard_1998_to_2022-csv/", all_csvs[i]), 
  ...
  thisFile_new <- left_join(thisFile, party_table_final, by= c("party" = "name_short_hansard"))
